# Read in and plot cummulative length distribution  
...
with open('XTC_NoEndSev_NoAnn\\Length_3-4.csv', 'r') as file:
...
with open('XTC_WithEndSev_NoAnn\\Length_3-4.csv', 'r') as file:
    LenFile = csv.reader(file)
