...
with open('Keratocyte_NoEndSev_Ann\\Concentration.csv', 'r') as file:
...
with open('Keratocyte_WithEndSev_Ann\\Concentration.csv', 'r') as file:
...
plt.xticks([0,2.5,5,7.5,10,12.5,15,17.5,20], ['0','','5','','10','','15','','20']) 
plt.show()  
